  ...
  return (
    <>
      <div className="main-area">
        ...
        <div className="workportfolio11 workportfolio-section">
          <Container>
            <Row className="align-items-center bg portfolio11">
                <Col md="4">
                  <div className="workportfoliooneonea">
                    <h2>Vloggi</h2>
                    <p>
                      Vloggi is a startup based on Sydney Australia. It provides
                      service to large enterprise to small business. It allows
                      enterprise to make custom video which they collected from
                      their user.
                    </p>
                    <p>
                      For this unique concept this startup raised $3.4M funding
                      till now.
                    </p>
                    <p>
        ...
        <div className="workportfolio0 workportfolio-section">
          <Container>
        ...
        <div className="workportfolio1 workportfolio-section">
          <Container>
            <Row className="align-items-center bg portfolio1">
                <Col md="4">
                  <div className="workportfolioonea">
                    ...
                    <Link
                      to={"images/Doctor_Book_Appoinement_System-PDF.pdf"}
                      className="btn btn-purple"
                      target="_blank"
                    >
                      View More
        ...
        <div className="workportfolio2 workportfolio-section">
          <Container>
            <Row className="align-items-center">
                <Col md="6">
                  <div className="portfolio-item-wrapper" data-aos="fade-up">
        ...
        <div className="workportfolio3 workportfolio-section">
          <Container>
            <Row className="align-items-center bg portfolio3">
                <Col md="4">
                  <div className="workportfoliothreea">
                    <h2>Pay scall</h2>
                    <p>
                      Pay scall is Indonesian based startup, which provide their
                      services to the small to medium business.
                    </p>
                    <p>
                      It tracks employees salary, how much amount is pending,
                      when they took a leave, even attendance too.
                    </p>
                    <p>App provides every employees details very precisely.</p>
                    <p>We'd done branding, UX as well as application design.</p>
                    <a
        ...
        <div className="workportfolio4 workportfolio-section">
          <Container>
            <Row className="align-items-center">
                <Col md="6">
                  <div className="portfolio-item-wrapper" data-aos="fade-up">
      ...
      <section id="dontfindwork" className="position-relative">
